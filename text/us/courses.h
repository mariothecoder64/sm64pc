COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       _("BIG BOB-OMB ON THE SUMMIT")     , _("SEX WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SEX"),
       _("FIND THE 7 ASSESS")          , _("MARIO WINGS TO THE SKY")        , _("INSIDE CHAIN CHOMP'S ASS"))

COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S FORTRESS"),
       _("CHOP OFF WHOMP'S COCK")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FUCKING ARSE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))
...
COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL MOUNTAIN"),
       ...
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL NEVER FUCKING WORK"))
